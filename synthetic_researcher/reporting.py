...
def build_markdown_report(run: SurveyRun) -> str:
    ...
    lines = [
        "# VCA Multi-Agent Synthetic Researcher Report",
        "",
        f"Run ID: `{run.run_id}`",
        ...
        *[f"- {item}" for item in decision.get("so_what", [])],
        ...
        "## Proposition Summary",
        "",
        "| Proposition | Adoption index | Mean Likert | Respondents |",
        "| --- | ---: | ---: | ---: |",
    ]
    ...
    lines.extend([
        ...
        "## Pricing Signals",
        "",
        "| Proposition | Weighted mean acceptable fee | Range |",
        "| --- | ---: | --- |",
    ])
    ...
    lines.extend([
        ...
        "## Segment Fit",
        "",
        "| Proposition:Segment | Mean Likert |",
        "| --- | ---: |",
    ])
